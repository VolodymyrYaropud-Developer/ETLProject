...
The core goal is to demonstrate best practices in data handling:
- Streaming for memory efficiency
- In-memory deduplication
- Data transformation (including timezone conversion)
- High-performance database loading using `SqlBulkCopy`
...
1. **Database Setup**: Execute the SQL scripts to create the `TaxiTripData` database and the `Trips` table with the defined indexes.
